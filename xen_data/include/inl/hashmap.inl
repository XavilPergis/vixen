...
#define _XEN_FXHASHER_WRITE_OVERLOAD(T)               \
    template <>                                       \
...
_XEN_FXHASHER_WRITE_OVERLOAD(u64)
_XEN_FXHASHER_WRITE_OVERLOAD(u32)
_XEN_FXHASHER_WRITE_OVERLOAD(u16)
_XEN_FXHASHER_WRITE_OVERLOAD(u8)
_XEN_FXHASHER_WRITE_OVERLOAD(i64)
_XEN_FXHASHER_WRITE_OVERLOAD(i32)
_XEN_FXHASHER_WRITE_OVERLOAD(i16)
_XEN_FXHASHER_WRITE_OVERLOAD(i8)
